    ...
    >
      <div className="max-w-5xl mx-auto px-4 h-14 flex items-center gap-4">
        ...
        <div style={{ marginLeft: 'auto' }}>
          <a href="/#contact" style={{ fontSize: 12, fontWeight: 700, color: '#fff', background: 'linear-gradient(135deg, #2563eb, #3b82f6)', padding: '7px 16px', borderRadius: 6, textDecoration: 'none' }}>
            相談する
          </a>
        </div>
      </div>
